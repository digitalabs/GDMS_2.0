...
public class PdfFileBuilder extends FileBuilder {
	...
	private Document document;
	    ...
	    private static Font subFont = new Font(Font.FontFamily.TIMES_ROMAN, 10,
	            Font.UNDERLINE);
	    private static Font subCell = new Font(Font.FontFamily.TIMES_ROMAN, 9,
	            Font.NORMAL);
	    ...
	    protected void resetContent() {
	    	...
	    	if(columnCount > 10) {
			    catFont = new Font(Font.FontFamily.TIMES_ROMAN, 10,
			            Font.BOLD);
			    subFont = new Font(Font.FontFamily.TIMES_ROMAN, 8,
			            Font.UNDERLINE);
			    subCell = new Font(Font.FontFamily.TIMES_ROMAN, 7,
			            Font.NORMAL);
	    	}
	    	if(columnCount > 12) {
	    		return;
