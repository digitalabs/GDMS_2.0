...
public abstract class FileBuilder implements Serializable {
    ...
    public void setVisibleColumns(Object[] visibleColumns) {
        ...
        if(null != visibleColumns) {
        	setVisibleColumnsLength(visibleColumns.length);
        }
    }
	...
	public void setVisibleColumnsLength(int iNumOfCols) {
		_iNumberOfCol = iNumOfCols;
	}
}
